---
title: The New Demographic Battlefield
permalink: /projects/predict-cd-pvi/
layout: single
author_profile: true
toc: true
toc_sticky: true
...
<p align="center">
  <a href="https://2022midterms.streamlit.app/" target="_blank">
    <img
      src="https://img.shields.io/badge/Explore%20My%20Interactive%20App%20for%20US%20Congressional%20Districts!-red"
      alt="Explore Streamlit App"
      style="max-width:100%;"
    />
  </a>
</p>
...
[![Distribution of PVI Scores](images/Distribution_of_PVI_Scores.png)](images/Distribution_of_PVI_Scores.png){:target="_blank" rel="noopener"}
...
[![Redistricting Type Composite](images/Redistricting_Type_Composite.png)](images/Redistricting_Type_Composite.png){:target="_blank" rel="noopener"}
...
[![Facet Grid](images/FacetGrid_PVI.png)](images/FacetGrid_PVI.png){:target="_blank" rel="noopener"}
...
[![Dem Features PVI](images/Dem_Features_PVI.png)](images/Dem_Features_PVI.png){:target="_blank" rel="noopener"}

#### Top Republican Features for Predicting PVI  

[![Rep Features PVI](images/Rep_Features_PVI.png)](images/Rep_Features_PVI.png){:target="_blank" rel="noopener"}
...
[![Dem Features 22](images/Dem_Features_22.png)](images/Dem_Features_22.png){:target="_blank" rel="noopener"}

### Top 2022 Midterm Republican Features  
**Most Influential Republican Features for Predicting 2022 Midterm Voting Behavior**  
[![Rep Features 22](images/Rep_Features_22.png)](images/Rep_Features_22.png){:target="_blank" rel="noopener"}
